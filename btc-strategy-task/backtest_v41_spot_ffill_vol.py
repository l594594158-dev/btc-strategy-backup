...
OUT = f'{DATA_DIR}/backtest_v41_spot_ffill_vol.csv'
TP, SL = 0.025, 0.015
...
vol5m = (v5 / v5.rolling(20).mean()).fillna(1.0).values
...
for i in range(n5m):
    ...
    long_sig_now = h4b and d1b and within and adx1_ok and adx4_ok and volok and rsi5m[i] > 40
    short_sig_now = (not h4b) and (not d1b) and within and adx1_ok and adx4_ok and volok and rsi5m[i] < 60
