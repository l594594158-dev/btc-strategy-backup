...
def check_entry(data):
    ...
    # v2.20: RSI<30 + 1h ADX<30
    if not r4h['bullish'] and not rd['bullish'] and pctb <= 0.15 and rsi5m < 30 and adx1h < 30:
        bb_l = r5m['bb_l']
    ...
    # v2.19: RSI 65~85 + 1h ADX > 25
    if not r4h['bullish'] and not rd['bullish'] and pctb > 0.85 and rsi5m >= 65 and rsi5m <= 85 and adx1h > 25:
