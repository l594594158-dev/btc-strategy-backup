...
# ========== 主循环 ==========
def main():
    log(f"🚀 BTC自动交易启动 v2.17 | {POLL_INTERVAL}秒轮询 | {LEVERAGE}x | 首仓{INITIAL_QTY}+补仓{ADDON_QTY}BTC | 上限{MAX_POSITIONS_PER_DIR}仓")
    log(f"v2.17: 补仓ADX保护 | 首仓记录1h+4h ADX | 补仓需ADX≤首仓ADX")
